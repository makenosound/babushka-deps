...
subl "GotoWindow.subl_package" do
  source "https://github.com/ccampbell/sublime-goto-window"
end
...
subl "SublimeLinter-jsxhint.subl_package" do
  source "https://github.com/SublimeLinter/SublimeLinter-jsxhint"
end
